...
import { Input, Button, CollapsibleSection } from './EditorUI';
            ...
            <CollapsibleSection title="Policy Check" icon={ShieldAlert} defaultOpen={true}>
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-xl">
                    ...
                    <div className="flex items-end gap-2">
                        ...
                        <span className="text-xs text-red-300 mb-1">Compliance</span>
                    </div>
...
export const LogicPanel: React.FC = () => (
    <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-2 bg-dark-950">
        <div className="flex-1 overflow-y-auto custom-scrollbar">
            ...
            <CollapsibleSection title="Rules" icon={List} defaultOpen={true}>
                <div className="space-y-2">
